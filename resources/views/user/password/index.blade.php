...
@section('header')
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item"><span>Lista de Solicitudes</span></li>
    </ul>
                ...
                <div class="content-box">
                    <div class="col-sm-12">
                        <div class="element-wrapper">
                            <h4 class="header">Solicitud de Cambio de Contraseña de Router Wi-fi</h4>
                            <div class="element-box-tp"><!--------------------
START - Controls Above Table
-------------------->
                                <!--Large modal-->
                                <button class="mr-2 mb-2 btn btn-primary" data-target=".bd-example-modal-lg"
                                        data-toggle="modal"> Cambiar
                                </button>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group"><label for=""> Contraseña Nueva</label><input class="form-control" name="nuevo"
                                                                                                                            type="text"></div>
                                                        </div>
                                                        <div class="col-sm-6">
